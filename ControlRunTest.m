...
clc
n = 5;
zeta = 5; % the number of games in each level of dogfight between the winners
...
switch control
    ...
    case 2
        tic
        [finalTraits,winnersDogfight,mostOftenWinner] = dogfightNI(n,zeta,weightOfConsistency);
        toc
        levels = true;
        level = 2;
   case 2.1
