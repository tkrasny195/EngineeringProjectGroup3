function [fullnTurnsStore,fullTotalBets,fullTotalDice,winners,traitsWinner,traits] = gameLoop(n,winners,fullnTurnsStore,fullTotalBets,fullTotalDice,fullPlayerData)
...
for iC = 1:n
    ...
    % runs a game
    [nTurnsStore,totalBets,totalDice,playerData,winners,traitsWinner,traits,winner] = runGame(rounds,nsDice,win,turn,likelyBS,traits,pHonestArray,nTurnsStore,totalBets,totalDice,playerData,lies,truths,iC,winners);
