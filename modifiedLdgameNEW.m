function [bestTraits] = modifiedLdgameNEW(n,weightOfConsistency)
% 4/12/19
% Thomas Kasl
...
[traitsWinner,traits,traitsWinners] = modifiedGameLoop(n,weightOfConsistency);

%% Call output best traits function
bestTraits = modifiedOutputTraitsStructure(traits,traitsWinner,weightOfConsistency,traitsWinners);