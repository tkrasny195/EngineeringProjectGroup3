function [finalFinalFinalTraits,winnersDogfight,mostOftenWinner] = dogfight3NI(n,zeta,weightOfConsistency)
% Number of levels: 4
% Total games: 1597
...
[finalFinalFinalTraits,winnersDogfight,mostOftenWinner] = dogfightGame(gamma,finalFinalTraits);
