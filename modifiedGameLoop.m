function [traitsWinner,traits] = modifiedGameLoop(n,weightOfConsistency)
% 4/12/19
% Thomas Kasl
...
for iC = 1:n
    ...
    traits = modifiedAveragePlayerTraits(traits,traitsWinner,iC,weightOfConsistency);
    ...
    % runs a game
    [traitsWinner,traits] = modifiedRunGame(nsDice,win,turn,likelyBS,traits,pHonestArray,lies,truths);
