function [nTurnsStore,totalBets,totalDice,playerData,winners,traitsWinner,traits,winner] = runGame(rounds,nsDice,win,turn,likelyBS,traits,pHonestArray,nTurnsStore,totalBets,totalDice,playerData,lies,truths,iC,winners)
