function [traitsWinner,traits, winnersArray] = modifiedRunGame(nsDice,win,turn,likelyBS,traits,pHonestArray,lies,truths, winnersArray)
...
winnersArray = [winnersArray winner];