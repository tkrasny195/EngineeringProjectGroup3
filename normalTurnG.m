function [quant, numb, bs] = normalTurnG(goDice,traits,turn,nDice,bets,likelyBS,pHonestArray,nsDice,quant,numb,bs)
% Description
%   INPUTS
%    goDice - see above
%    traits - see above
...
oldNumb = numb;
%% Identity
weightsArray = diceWeightsG(bets, pHonestArray, turn, traits, nDice, nsDice, goDice);
