function finalFinalFinalTraits = meanDogfight3NI(n,zeta,weightOfConsistency)
% Number of levels: 4
% Total games: 1597
...
for i = 1:5
    traits = meanDogfight2(epsilon,zeta,n,weightOfConsistency);
...
finalFinalFinalTraits = modifiedDogfightGame(gamma,finalFinalTraits);
