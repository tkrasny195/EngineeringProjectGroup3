function [finalFinalTraits,winnersDogfight,mostOftenWinner] = dogfight2NI(n,zeta,weightOfConsistency)
% Number of levels: 3
% Total games: 265
...
[finalFinalTraits,winnersDogfight,mostOftenWinner] = dogfightGame(epsilon,finalTraits);
